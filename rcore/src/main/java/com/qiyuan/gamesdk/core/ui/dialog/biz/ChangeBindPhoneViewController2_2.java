...
public class ChangeBindPhoneViewController2_2 extends BaseAuthViewController {
    ...
    public ChangeBindPhoneViewController2_2(Context context, IDialogParam params) {
    ...
    public int getLayoutResourceId() {
        return R.layout.qy_sdk_container_change_bind_phone2_2;
    }
    ...
    private void initView() {
        ...
        getVerificationCodeButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                IMEUtil.hideIME(ChangeBindPhoneViewController2_2.this);
                //获取验证码
