...
import com.qiyuan.gamesdk.core.storage.db.global.ChildrenAccountTable;
...
public class ChildrenAccountHistoryInfo {
    ...
    public static ContentValues transformToCV(ChildrenAccountHistoryInfo info) {
        ...
        cv.put(ChildrenAccountTable.COL_QY_ACCOUNT, info.QYAccount);
    ...
    public static ChildrenAccountHistoryInfo transformFromCursor(Cursor cursor) {
        ...
        info.QYAccount = cursor.getString(ChildrenAccountTable.INDEX_QY_ACCOUNT);
