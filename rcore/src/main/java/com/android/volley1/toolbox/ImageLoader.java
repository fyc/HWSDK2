...
public class ImageLoader {
    ...
    /**
     * Equivalent to calling {@link #get(String, ImageListener, int, int, ScaleType, ProgressListener)} with
     ...
     */
    public ImageContainer get(String requestUrl, ImageListener imageListener,
            int maxWidth, int maxHeight, ScaleType scaleType,ProgressListener listener) {
        ...
        newRequest.setProgressListener(listener);
