...
public class ScalableImageView extends ImageView {
    ...
    public ScalableImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        int index = a.getInt(R.styleable.ScalableImageView_android_scaleType, -1);
        if (index >= 0) {
        ...
        cornerRadius = a.getDimensionPixelSize(R.styleable.ScalableImageView_riv_corner_radius, -1);
        borderWidth = a.getDimensionPixelSize(R.styleable.ScalableImageView_riv_border_width, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.ScalableImageView_riv_border_color);
        if (borderColor == null) {
            borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
        }

        mutateBackground = a.getBoolean(R.styleable.ScalableImageView_riv_mutate_background, false);
        isOval = a.getBoolean(R.styleable.ScalableImageView_riv_oval, false);
     ...
     * @return
     */
    public ScalableImageView setRoundConner(int radius) {
        if (cornerRadius == radius) { return this; }
...
//                canvas.drawRoundRect(rectF, mRoundConnerSize, mRoundConnerSize, paint);
//            }
//        }
//        super.onDraw(canvas);
//    }
